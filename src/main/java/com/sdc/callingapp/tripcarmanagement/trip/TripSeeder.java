...
////		Trip trip1 = new Trip("car1","user1", GucPoints.B3_U_AREA.getLatLng(), Arrays.asList(destination.setLocation(GucPoints.C3_U_AREA.getLatLng()), new TripDestination().setLocation(GucPoints.C3_U_AREA.getLatLng()) );
